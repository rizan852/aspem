          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              <div class="custom-control custom-radio">
                <input type="radio" id="botol" name="satuan" class="custom-control-input" value="Botol" <?php if ($row['satuan'] == "Botol") {
                                                                                                          echo "checked";
                                                                                                        } ?>>
            ...
            <div class="form-group col-md-4">
              <div class="custom-control custom-radio">
                <input type="radio" id="tablet" name="satuan" class="custom-control-input" value="Tablet" <?php if ($row['satuan'] == "Tablet") {
                                                                                                            echo "checked";
                                                                                                          } ?>>
